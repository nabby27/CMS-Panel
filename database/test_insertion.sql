...
INSERT INTO CATEGORIES (category_father_id, category_id, name) VALUES
(0, 0, 'ninguna'),
(0, 1, 'peliculas'),
(0, 2, 'series'),
(1, 3, 'super-heroes'),
...
INSERT INTO ARTICLES (article_id, name, description, picture, category_id) VALUES
...
(7, 'Antes de ti', 'Louisa “Lou” Clark (Emilia Clarke), una chica inestable y creativa, reside en un pequeño pueblo de la campiña inglesa. Vive sin rumbo y va de un trabajo a otro para ayudar a su familia a llegar a fin de mes. Sin embargo, un nuevo trabajo pondrá a prueba su habitual alegría. En el castillo local, se ocupa de cuidar y acompañar a Will Traynor (Sam Claflin), un joven y rico banquero que se quedó paralítico tras un accidente.', 'antes.jpg', 5),
(8, 'Bajo la misma estrella', 'A pesar de que un milagro médico ha conseguido reducir su tumor y darle unos años más de vida, la adolescente Hazel (Shailene Woodley) siempre se ha considerado una enferma terminal. Sin embargo, cuando el joven Gus (Ansel Elgort) entra a formar parte del grupo de ayuda para enfermos de cáncer juvenil, la vida de Hazel se transforma por completo.', 'estrella.jpg', 5),
...
INSERT INTO PICTURES (picture_id, picture, description, article_id) VALUES
...
INSERT INTO LINKS (link_id, name, link, article_id) VALUES
...
INSERT INTO TYPE_OF_USERS (type_id, type_user) VALUES
(1, 'administrador'),
(2, 'usuario');

INSERT INTO USERS (user_id, name, surname, email, telephon, address, password, type_id) VALUES
('pepito24', 'Pepe', 'Garcia Garcia', 'pepe123@gmail.com', 964585296, 'C/De Mentira 555', '12345', 1),
('ivan27', 'Ivan', 'Cordoba Donet', 'ivan27@gmail.com', 963485214, 'Av Sin name 111','12345', 2);